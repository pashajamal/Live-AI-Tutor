...
# 2. Tavus ke configurations
PERSONA_ID = "<PERSONA_ID>"
REPLICA_ID = "<REPLICA_ID>"

# Tavus API v2 requests ke liye authentication aur data type headers setup karna
HEADERS = {"x-api-key": TAVUS_API_KEY, "Content-Type": "application/json"}
API = "https://tavusapi.com/v2"

# 3. HTML Jinja Template: Web interface ka layout aur styles
HTML = """
<!doctype html>
<html lang="en">
<head>
...
# 4. Flask Application initialization
app = Flask(__name__)
...
def index():
    ...
    # Agar user ne 'Start Live Call' button dabaya hai (Form submit kiya hai)
